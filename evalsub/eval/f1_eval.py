...
def main(args):
    ...
    f1_process(ref_file_path, sys_file_path, cst.NEUTRAL_TAG, srt=srt, line_tag=cst.LINE_TAG, caption_tag=cst.CAPTION_TAG)
    f1_process(ref_file_path, sys_file_path, cst.CAPTION_TAG, srt=srt, line_tag=cst.LINE_TAG, caption_tag=cst.CAPTION_TAG)
    f1_process(ref_file_path, sys_file_path, cst.LINE_TAG, srt=srt, line_tag=cst.LINE_TAG, caption_tag=cst.CAPTION_TAG)
