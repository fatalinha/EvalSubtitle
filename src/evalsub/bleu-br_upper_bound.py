...
from util.degrade_tagged_txt import mixed as mixed_tags
from util.degrade_txt import mixed as mixed_txt


LINE_TAG = '<eol>'
CAPTION_TAG = '<eob>'
OUT_DIR_PATH = '/home/alin/Desktop/subtitling/03_scripts/EvalSub/02_contrastive_pairs/mixed'
